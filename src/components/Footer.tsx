    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 grid sm:grid-cols-3 gap-8">
      ...
      <div>
        <ul className="flex items-center gap-8 text-white/70">
          ...
          <li>
            <a href="https://www.linkedin.com/company/istecgcuniversity/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:text-[#2ee892] transition-colors">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <li>
            <a href="https://www.instagram.com/cgcuniversity_iste?igsh=MTFubmM5djN0YmJrcA==" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:text-[#2ee892] transition-colors">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
